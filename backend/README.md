...
## Project Structure
    ...
    ├── testapiautocatalog_116444  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116444`
...
2. Clone this repo and `cd testapiautocatalog_116444`
